...
- **Sudah dibetulkan:** addon "Tambahan lapangan (di luar paket), Rp200rb/lapangan" dihapus dari halaman harga. Keputusannya (9 Agustus 2026): tidak ada jalur beli lapangan satu-satu, tenant yang kena batas jumlah lapangan tetap diarahkan upgrade ke Premium untuk lapangan tanpa batas, sesuai yang `LapanganAdminController::store()` memang sudah lakukan ("Upgrade paket untuk tambah lebih banyak"). Halaman harga sekarang sudah cocok dengan perilaku sistem.
...
5. ~~Cek ulang tabel harga dan fitur di bagian 3, apakah masih sesuai dengan yang benar-benar dijual sekarang.~~ **Sudah dicek.** Harga dan fitur inti sudah cocok, teks "Reminder otomatis" yang kelewat janji sudah dibetulkan.
6. ~~Putuskan nasib addon "Tambahan lapangan Rp200rb/lapangan".~~ **Sudah diputuskan.** Tidak ada jalur beli lapangan satu-satu, tenant yang kena batas tetap diarahkan upgrade ke Premium untuk lapangan tanpa batas. Addon itu dihapus dari halaman harga, tidak ada yang perlu dibangun.
