...
<html lang="id">
    ...
    <body class="font-sans antialiased bg-cream text-ink">
        ...
        <div class="max-w-md mx-auto px-5 py-16 text-center">
            ...
            <a href="{{ route('pricing') }}" class="inline-flex items-center justify-center rounded-lg font-sans font-semibold text-sm px-5 py-2.5 border-2 border-sand text-ink-mid hover:border-brown-light hover:text-brown transition-colors">
